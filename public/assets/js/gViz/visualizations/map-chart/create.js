    ...
    if (validate(step)) {
      ...
      switch (step) {
        ...
        case 'run':
          ...
          // Create map element
          _var.map = L.map(_var.container.el, { minZoom: 5 })
          ...
          /*
          // Draw svg
          _var.wrap = _var.container.d3.selectAll('svg.chart-' + _var._id)
          ...
          _var.wrap = _var.wrap.enter()
            .append("svg")
            .attr('class', _var._class + ' chart-' + _var._id)
            .merge(_var.wrap); // svg
          ...
          // Draw g
          _var.g = _var.wrap.selectAll("g.chart-wrap")
            .data(["chart-wrap"]); // svg:g
