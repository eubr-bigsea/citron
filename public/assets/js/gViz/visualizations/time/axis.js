        ...
        case 'run':
          ...
          switch (action) {
            ...
            case 'create':
              ...
              _var.x_axis
                .call(_var.xAxis.tickFormat(gViz.helpers.date.format.hms.format))
                .attr("transform", `translate(0,${_var.height})`)
                .selectAll('.tick text')
                  .attr('transform',  function(d, i) {
                    if( i == 0 ) { return `translate(${this.getBBox().width * .5},0)`; }
                    else if( i == x_ticks.length-1 ) { return `translate(${-this.getBBox().width * .5},0)`; }
              ...
              _var.y_axis
                .call(_var.yAxis.tickValues(y_ticks).tickFormat(gViz.helpers.number.format.s))
                .selectAll('.tick text')
                  .attr('text-anchor', 'end')
                  .attr('transform', function(d, i) {
                    switch (i) {
                      case 0: return `translate(-5,${-(this.getBBox().height / 2)})`;
                      case y_ticks.length-1: return "translate(-5,1)";
                      default: return "translate(-5,-1)";
                    }
                  });
            ...
            case 'ticks':
              ...
              return (() => { switch (type) {
                ...
                case 'x':
                  ...
                  // Generate bins
                  __range__(0, bins, true).forEach((d,i) => ticks.push(new Date(parseInt(_var.x.domain()[0] + (size*i)))));
                ...
                case 'y':
                  ...
                  // Generate bins
                  __range__(0, bins, true).forEach((d,i) => ticks.push(_var.y.domain()[0] + (size*i)));
