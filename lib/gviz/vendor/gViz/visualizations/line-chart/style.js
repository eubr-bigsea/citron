      ...
      switch (step) {
        ...
        case 'run':
          ...
          _var.lineWidth = function(d) {
            return '2px'; //d.strokeWidth != null && !isNaN(d.strokeWidth) ? d.strokeWidth + "px" : "1px";
          }
          ...
          _var.pointSize = function(d) {
            return 3; //d.pointSize != null ? d.pointSize : (d._parent.pointSize != null ? d._parent.pointSize : 2);
          }
