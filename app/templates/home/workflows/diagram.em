.__workflows__draw
  ...
  .container-fluid#diagram-container-wrapper
    ...
    .workflow-diagram-wrapper.row
      = workflows/workflow-diagram1 workflow=model.workflow graph=graph paper=paper operations=model.operations hasChanged=hasChanged formsChanged=formsChanged displayForm=displayForm clickTask=(action 'clickTask') closeForms=(action 'closeForms') getAttributeSuggestions=(action 'getAttributeSuggestions') selectedTask=selectedTask
