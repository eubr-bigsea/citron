  ...
  .row
    ...
    .col-12.form-block
      ...
      .form-group.row#last_name
        ...
        .col-10
         ...
         each model.errors.lastName as |error|
           span.has-error : = error.message
      .form-group.row
        label.col-2.col-form-label for='email'
      ...
      .form-group.row#locales
        label.col-2.col-form-label for='locales'
      ...
      if changePassword
        .form-group.row#current_password
          label.col-2.col-form-label for='currentPassword'
        ...
        .form-group.row#password
          label.col-2.col-form-label for='password'
        ...
        .form-group.row#password_confirmation
          label.col-2.col-form-label for='newPasswordConfirmation'
